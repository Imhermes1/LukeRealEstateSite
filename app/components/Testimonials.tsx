      ...
      <div className="container">
        ...
        <div className="testimonials-grid">
          <blockquote className="testimonial">
            <p>"Luke negotiated the sale of our family home with professionalism and empathy, achieving an amazing price, that exceeded our expectations."</p>
            <cite>- Sarah.</cite>
          </blockquote>
          <blockquote className="testimonial">
            <p>"Seamless experience from listing to settlement, Luke's market insight is second to none."</p>
            <cite>- David.</cite>
          </blockquote>
          <blockquote className="testimonial">
